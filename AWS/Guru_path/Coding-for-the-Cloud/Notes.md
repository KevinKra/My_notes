...
- Explain the serverless paradigm.
- What are the principles of serverless? (5)
- What is "Lift and Shift", how does it compare to the other cloud development scenarios?
- What are the Cloud Development Patterns? (6)
